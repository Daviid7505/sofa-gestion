<template>
    ...
    <div class="d-flex flex-row">
        <div class="botones">
          <router-link to="/verproveedores" style="text-decoration:none; color:white;"> <button class="btn" id="cancelar">Cancelar</button></router-link>
        <button class="btn" id="enviar" type="submit">Actualizar</button>
         </div>
    </div>
  </div>
      </form>
