 ...
 <header>
    ...
    <div class="container">
      ...
      <div class="container-title">
        ...
        <router-link to="/crear-cliente" style="text-decoration:none;">
              ...
              <tr v-for="cliente in clientes" :key="cliente.idCliente">
                ...
                <td class="botones">
                  <div class="d-flex flex-row">
                    ...
                    <button class="btn btn-danger" @click="eliminarCliente(cliente.idCliente)" ><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0,0,256,256">
